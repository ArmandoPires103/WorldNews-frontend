...
const WorldMap = () => {
    ...
    // Comprehensive mapping from SVG path numeric IDs to country codes and names
    const countryIdMap = {
        ...
        '16': { code: 'sd', name: 'Sudan' },
        '17': { code: 'et', name: 'Ethiopia' },
        '18': { code: 'so', name: 'Somalia' },
        '19': { code: 'tz', name: 'Tanzania' },
        '20': { code: 'mz', name: 'Mozambique' },
        '21': { code: 'gb', name: 'United Kingdom' },
        '22': { code: 'fr', name: 'France' },
        '23': { code: 'de', name: 'Germany' },
        '24': { code: 'it', name: 'Italy' },
        '25': { code: 'es', name: 'Spain' },
        '26': { code: 'pt', name: 'Portugal' },
        '27': { code: 'nl', name: 'Netherlands' },
        '28': { code: 'be', name: 'Belgium' },
        '29': { code: 'ch', name: 'Switzerland' },
        '30': { code: 'at', name: 'Austria' },
        '31': { code: 'pl', name: 'Poland' },
        '32': { code: 'cz', name: 'Czech Republic' },
        '33': { code: 'sk', name: 'Slovakia' },
        '34': { code: 'hu', name: 'Hungary' },
        '35': { code: 'ro', name: 'Romania' },
        '36': { code: 'bg', name: 'Bulgaria' },
        '37': { code: 'gr', name: 'Greece' },
        '38': { code: 'tr', name: 'Turkey' },
        '39': { code: 'ua', name: 'Ukraine' },
        '40': { code: 'by', name: 'Belarus' },
        '41': { code: 'lt', name: 'Lithuania' },
        '42': { code: 'lv', name: 'Latvia' },
        '43': { code: 'ee', name: 'Estonia' },
        '44': { code: 'fi', name: 'Finland' },
        '45': { code: 'se', name: 'Sweden' },
        '46': { code: 'no', name: 'Norway' },
        '47': { code: 'dk', name: 'Denmark' },
        '48': { code: 'is', name: 'Iceland' },
        '49': { code: 'ie', name: 'Ireland' },
        '50': { code: 'jp', name: 'Japan' },
        '51': { code: 'kr', name: 'South Korea' },
        '52': { code: 'kp', name: 'North Korea' },
        '53': { code: 'mn', name: 'Mongolia' },
        '54': { code: 'kz', name: 'Kazakhstan' },
        '55': { code: 'uz', name: 'Uzbekistan' },
        '56': { code: 'tm', name: 'Turkmenistan' },
        '57': { code: 'kg', name: 'Kyrgyzstan' },
        '58': { code: 'tj', name: 'Tajikistan' },
        '59': { code: 'af', name: 'Afghanistan' },
        '60': { code: 'pk', name: 'Pakistan' },
        '61': { code: 'bd', name: 'Bangladesh' },
        '62': { code: 'mm', name: 'Myanmar' },
        '63': { code: 'th', name: 'Thailand' },
        '64': { code: 'vn', name: 'Vietnam' },
        '65': { code: 'kh', name: 'Cambodia' },
        '66': { code: 'la', name: 'Laos' },
        '67': { code: 'my', name: 'Malaysia' },
        '68': { code: 'sg', name: 'Singapore' },
        '69': { code: 'id', name: 'Indonesia' },
        '70': { code: 'ph', name: 'Philippines' },
        '71': { code: 'bn', name: 'Brunei' },
        '72': { code: 'ir', name: 'Iran' },
        '73': { code: 'iq', name: 'Iraq' },
        '74': { code: 'sy', name: 'Syria' },
        '75': { code: 'jo', name: 'Jordan' },
        '76': { code: 'lb', name: 'Lebanon' },
        '77': { code: 'il', name: 'Israel' },
        '78': { code: 'ps', name: 'Palestine' },
        '79': { code: 'sa', name: 'Saudi Arabia' },
        '80': { code: 'ye', name: 'Yemen' },
        '81': { code: 'om', name: 'Oman' },
        '82': { code: 'ae', name: 'United Arab Emirates' },
        '83': { code: 'qa', name: 'Qatar' },
        '84': { code: 'bh', name: 'Bahrain' },
        '85': { code: 'kw', name: 'Kuwait' },
        '86': { code: 'ge', name: 'Georgia' },
        '87': { code: 'am', name: 'Armenia' },
        '88': { code: 'az', name: 'Azerbaijan' },
        '89': { code: 'ar', name: 'Argentina' },
        '90': { code: 'cl', name: 'Chile' },
        '91': { code: 'pe', name: 'Peru' },
        '92': { code: 'bo', name: 'Bolivia' },
        '93': { code: 'py', name: 'Paraguay' },
        '94': { code: 'uy', name: 'Uruguay' },
        '95': { code: 'ec', name: 'Ecuador' },
        '96': { code: 'co', name: 'Colombia' },
        '97': { code: 've', name: 'Venezuela' },
        '98': { code: 'gy', name: 'Guyana' },
        '99': { code: 'sr', name: 'Suriname' },
        '100': { code: 'gf', name: 'French Guiana' },
        '101': { code: 'gt', name: 'Guatemala' },
        '102': { code: 'bz', name: 'Belize' },
        '103': { code: 'sv', name: 'El Salvador' },
        '104': { code: 'hn', name: 'Honduras' },
        '105': { code: 'ni', name: 'Nicaragua' },
        '106': { code: 'cr', name: 'Costa Rica' },
        '107': { code: 'pa', name: 'Panama' },
        '108': { code: 'cu', name: 'Cuba' },
        '109': { code: 'jm', name: 'Jamaica' },
        '110': { code: 'ht', name: 'Haiti' },
        '111': { code: 'do', name: 'Dominican Republic' },
        '112': { code: 'pr', name: 'Puerto Rico' },
        '113': { code: 'tt', name: 'Trinidad and Tobago' },
        '114': { code: 'bs', name: 'Bahamas' },
        '115': { code: 'bb', name: 'Barbados' },
        '116': { code: 'gd', name: 'Grenada' },
        '117': { code: 'lc', name: 'Saint Lucia' },
        '118': { code: 'vc', name: 'Saint Vincent and the Grenadines' },
        '119': { code: 'ag', name: 'Antigua and Barbuda' },
        '120': { code: 'kn', name: 'Saint Kitts and Nevis' },
        '121': { code: 'dm', name: 'Dominica' },
        '122': { code: 'gh', name: 'Ghana' },
        '123': { code: 'ci', name: 'Ivory Coast' },
        '124': { code: 'bf', name: 'Burkina Faso' },
        '125': { code: 'ml', name: 'Mali' },
        '126': { code: 'ne', name: 'Niger' },
        '127': { code: 'td', name: 'Chad' },
        '128': { code: 'cf', name: 'Central African Republic' },
        '129': { code: 'cm', name: 'Cameroon' },
        '130': { code: 'gq', name: 'Equatorial Guinea' },
        '131': { code: 'ga', name: 'Gabon' },
        '132': { code: 'cg', name: 'Republic of the Congo' },
        '133': { code: 'cd', name: 'Democratic Republic of the Congo' },
        '134': { code: 'ao', name: 'Angola' },
        '135': { code: 'zm', name: 'Zambia' },
        '136': { code: 'zw', name: 'Zimbabwe' },
        '137': { code: 'bw', name: 'Botswana' },
        '138': { code: 'na', name: 'Namibia' },
        '139': { code: 'sz', name: 'Swaziland' },
        '140': { code: 'ls', name: 'Lesotho' },
        '141': { code: 'mg', name: 'Madagascar' },
        '142': { code: 'mu', name: 'Mauritius' },
        '143': { code: 'sc', name: 'Seychelles' },
        '144': { code: 'km', name: 'Comoros' },
        '145': { code: 'mv', name: 'Maldives' },
        '146': { code: 'lk', name: 'Sri Lanka' },
        '147': { code: 'np', name: 'Nepal' },
        '148': { code: 'bt', name: 'Bhutan' },
        '149': { code: 'tw', name: 'Taiwan' },
        '150': { code: 'hk', name: 'Hong Kong' },
        '151': { code: 'mo', name: 'Macau' },
        '152': { code: 'nz', name: 'New Zealand' },
        '153': { code: 'pg', name: 'Papua New Guinea' },
        '154': { code: 'fj', name: 'Fiji' },
        '155': { code: 'sb', name: 'Solomon Islands' },
        '156': { code: 'vu', name: 'Vanuatu' },
        '157': { code: 'nc', name: 'New Caledonia' },
        '158': { code: 'ws', name: 'Samoa' },
        '159': { code: 'to', name: 'Tonga' },
        '160': { code: 'ki', name: 'Kiribati' },
        '161': { code: 'tv', name: 'Tuvalu' },
        '162': { code: 'nr', name: 'Nauru' },
        '163': { code: 'pw', name: 'Palau' },
        '164': { code: 'mh', name: 'Marshall Islands' },
        '165': { code: 'fm', name: 'Micronesia' },
        '166': { code: 'gu', name: 'Guam' },
        '167': { code: 'mp', name: 'Northern Mariana Islands' },
        '168': { code: 'as', name: 'American Samoa' },
        '169': { code: 'ck', name: 'Cook Islands' },
        '170': { code: 'pf', name: 'French Polynesia' },
        '171': { code: 'sn', name: 'Senegal' },
        '172': { code: 'gm', name: 'Gambia' },
        '173': { code: 'gw', name: 'Guinea-Bissau' },
        '174': { code: 'gn', name: 'Guinea' },
        '175': { code: 'sl', name: 'Sierra Leone' },
        '176': { code: 'lr', name: 'Liberia' },
        '177': { code: 'tg', name: 'Togo' },
        '178': { code: 'bj', name: 'Benin' },
        '179': { code: 'mr', name: 'Mauritania' },
        '180': { code: 'eh', name: 'Western Sahara' },
        '181': { code: 'tn', name: 'Tunisia' },
        '182': { code: 'dj', name: 'Djibouti' },
        '183': { code: 'er', name: 'Eritrea' },
        '184': { code: 'ug', name: 'Uganda' },
        '185': { code: 'rw', name: 'Rwanda' },
        '186': { code: 'bi', name: 'Burundi' },
        '187': { code: 'mw', name: 'Malawi' },
        '188': { code: 'cv', name: 'Cape Verde' },
        '189': { code: 'st', name: 'São Tomé and Príncipe' },
        '190': { code: 'rs', name: 'Serbia' },
        '191': { code: 'me', name: 'Montenegro' },
        '192': { code: 'ba', name: 'Bosnia and Herzegovina' },
        '193': { code: 'hr', name: 'Croatia' },
        '194': { code: 'si', name: 'Slovenia' },
        '195': { code: 'mk', name: 'North Macedonia' },
        '196': { code: 'al', name: 'Albania' },
        '197': { code: 'xk', name: 'Kosovo' },
        '198': { code: 'md', name: 'Moldova' },
        '199': { code: 'mt', name: 'Malta' },
        '200': { code: 'cy', name: 'Cyprus' },
    };
...
return (
    ...
    >
      ...
      <path
        ...
        ></path>
        <path class="allPaths" id="134" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="82" onClick={handleClick}>
        </path>
        <path class="allPaths" id="89" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="87" onClick={handleClick}>
        </path>
        <path class="allPaths" id="8" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="30" onClick={handleClick}>
        </path>
        <path class="allPaths" id="88" onClick={handleClick}
        ...
        <path class="allPaths" id="5" onClick={handleClick} d="M 578.5 47.2 571.5 50.6 569.2 47 571.3 46.2 576.8 46 578.5 47.2 Z">
        </path>
        <path class="allPaths" id="5" onClick={handleClick}
        ...
        <path class="allPaths" id="6" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="182" onClick={handleClick}>
        </path>
        <path class="allPaths" id="47" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="131" onClick={handleClick}>
        </path>
        <path class="allPaths" id="21" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="173" onClick={handleClick}>
        </path>
        <path class="allPaths" d="M1050.3 487.3l0 7.7-8.2 0-1.9 0.3-1.1-0.9 1.9-7.2 9.3 0.1z" 
            id="130" onClick={handleClick}>
        </path>
        <path class="allPaths" id="37" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="34" onClick={handleClick}>
        </path>
        <path class="allPaths" id="69"
            d="M 1667.5 567.6 1665.1 567.7 1658 563.2 1663.4 561.9 1666.2 563.9 1668 565.8 1667.5 567.6 Z">
        </path>
        <path class="allPaths" id="69" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="77" onClick={handleClick}>
        </path>
        <path class="allPaths" id="24" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="75" onClick={handleClick}>
        </path>
        <path class="allPaths" id="50" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="187" onClick={handleClick}>
        </path>
        <path class="allPaths" id="67" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="105" onClick={handleClick}>
        </path>
        <path class="allPaths" id="46" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="147" onClick={handleClick}>
        </path>
        <path class="allPaths" id="81" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="91" onClick={handleClick}>
        </path>
        <path class="allPaths" id="70" onClick={handleClick}
        ...
        <path class="allPaths" id="153" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="181" onClick={handleClick}>
        </path>
        <path class="allPaths" id="38" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="55" onClick={handleClick}>
        </path>
        <path class="allPaths"  onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="9" onClick={handleClick}>
        </path>
        <path class="allPaths" id="152" onClick={handleClick}
        ...
        <path class="allPaths" id="90" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="25" onClick={handleClick}>
        </path>
        <path class="allPaths" id="22" onClick={handleClick}
        ...
        <path class="allPaths" id="1" onClick={handleClick}
        ...
        <path class="allPaths" id="1" onClick={handleClick} d="M 115.1 365.9 114.8 366.6 111.8 366.4 112.4 365.6 115.1 365.9 Z">
        </path>
        <path class="allPaths" id="1" onClick={handleClick}
        ...
        <path class="allPaths" id="168" onClick={handleClick}
            d="M 27.7 593.3 27.4 593.7 27.2 594 27 594.1 26.6 593.8 26.8 593.6 27.1 593.6 27.2 593.4 27.7 593.3 Z">
        </path>
        <path class="allPaths" id="168" onClick={handleClick} d="M 34.3 593.3 33.8 593.4 33.7 593.2 34.1 593.1 34.3 593.3 Z">
        </path>
        <path class="allPaths" id="119" onClick={handleClick}
        ...
        <path class="allPaths"
            ...
            id="84" onClick={handleClick}>
        </path>
        <path class="allPaths" id="114" onClick={handleClick}
        ...
        <path class="allPaths" id="114" onClick={handleClick} d="M 572.6 349.8 572.3 350 572 349.9 571.9 349.7 572.5 349.5 572.6 349.8 Z">
        </path>
        <path class="allPaths" id="114" onClick={handleClick} d="M 564.4 347.9 564.3 347.8 564 347.1 564.2 347.1 564.4 347.9 Z">
        </path>
        <path class="allPaths" id="114" onClick={handleClick}
        ...
        <path class="allPaths" id="144" onClick={handleClick}
        ...
        <path class="allPaths" id="188" onClick={handleClick}
        ...
        <path class="allPaths" id="200" onClick={handleClick}
        ...
        <path class="allPaths" id="112" onClick={handleClick}
      ...
      {/* Add more path elements as needed */}
         ...
         {/* Modal */}
      <Modal isOpen={isOpen} onClose={handleCloseModal} countryInfo={countryInfo} countryResources={countryResources} />
    </div>
  );
};
